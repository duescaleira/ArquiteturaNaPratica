...
protocol UserProviderProtocol {
    ...
    func login(parameteres: [AnyHashable: Any], completionHandler: @escaping(Result<UserModel, Error>) -> Void)
}
...
class UserProvider: UserProviderProtocol {
    ...
    func login(parameteres: [AnyHashable : Any], completionHandler: @escaping (Result<UserModel, Error>) -> Void) {
        let body: NSDictionary = parameteres[Constants.ParametersKeys.body] as! NSDictionary
